...
export const KIDS_LOCATIONS: KidsLocation[] = [
  {
    ...
    words: [
      ...
      { letter: 'X', word: 'Fox',      emoji: '🦊', audioWord: 'fox' },
  ...
  },
  {
    ...
    words: [
      ...
      { letter: 'N', word: 'Nebula',        emoji: '🌫️', audioWord: 'nebula' },
      { letter: 'O', word: 'Orbit',         emoji: '🔄', audioWord: 'orbit' },
      { letter: 'P', word: 'Planet',        emoji: '🪐', audioWord: 'planet' },
      { letter: 'Q', word: 'Quasar',        emoji: '✨', audioWord: 'quasar' },
      ...
      { letter: 'W', word: 'Wormhole',      emoji: '🌀', audioWord: 'wormhole' },
      { letter: 'X', word: 'Xenon',         emoji: '💠', audioWord: 'xenon' },
      ...
      { letter: 'I', word: 'Ion',           emoji: '⚡', audioWord: 'ion' },
      { letter: 'K', word: 'Kite',          emoji: '🪁', audioWord: 'kite' },
  ...
  },
  {
    ...
    words: [
      ...
      { letter: 'N', word: 'Napkin',    emoji: '🧻', audioWord: 'napkin' },
      { letter: 'O', word: 'Oven',      emoji: '🫕', audioWord: 'oven' },
      { letter: 'P', word: 'Pillow',    emoji: '🛋️', audioWord: 'pillow' },
      { letter: 'Q', word: 'Quilt',     emoji: '🧶', audioWord: 'quilt' },
      { letter: 'R', word: 'Rug',       emoji: '🪆', audioWord: 'rug' },
      { letter: 'S', word: 'Shelf',     emoji: '📚', audioWord: 'shelf' },
      { letter: 'T', word: 'Towel',     emoji: '🧺', audioWord: 'towel' },
      { letter: 'U', word: 'Umbrella',  emoji: '☂️', audioWord: 'umbrella' },
      { letter: 'V', word: 'Vase',      emoji: '🏺', audioWord: 'vase' },
      { letter: 'W', word: 'Wall',      emoji: '🧱', audioWord: 'wall' },
      { letter: 'X', word: 'Xylophone', emoji: '🎹', audioWord: 'xylophone' },
      { letter: 'Y', word: 'Yarn',      emoji: '🧶', audioWord: 'yarn' },
      { letter: 'Z', word: 'Zipper',    emoji: '🤐', audioWord: 'zipper' },
      { letter: 'B', word: 'Bowl',      emoji: '🥣', audioWord: 'bowl' },
      { letter: 'C', word: 'Cup',       emoji: '☕', audioWord: 'cup' },
      { letter: 'F', word: 'Fan',       emoji: '🌀', audioWord: 'fan' },
      { letter: 'I', word: 'Iron',      emoji: '🧲', audioWord: 'iron' },
